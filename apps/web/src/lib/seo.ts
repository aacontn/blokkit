...
export const SITE_URL = (import.meta.env.PUBLIC_SITE_URL ?? "https://blokkit.cl")
  .replace(/\/$/, "");
...
const ROUTES: RouteSeoEntry[] = [
  {
    path: "/",
    title: "BloKKit | Solución de Control de Celulares para Colegios y Empresas",
    description:
      "Sistema de bloqueo Faraday que crea zonas libres de distracciones sin confiscar teléfonos. Ideal para colegios, universidades y empresas en Chile y Latinoamérica.",
    keywords: [
  ...
  {
    path: "/producto",
    title: "Producto | BloKKit",
    description:
      "Conoce el ecosistema BloKKit: Funda Faraday, Dock de Desbloqueo y Plataforma Digital.",
    keywords: [
      "funda faraday",
      "dock de desbloqueo",
      "plataforma de trazabilidad",
      "bloqueo 5G wifi bluetooth",
  ...
  },
  {
    ...
    keywords: [
      "politica de privacidad blokkit",
  ...
  },
  {
    ...
    keywords: [
      "terminos y condiciones blokkit",
      "uso del sitio web",
      "condiciones legales",
      "aviso legal blokkit",
    ],
